...
jQuery( document ).ready(function( $ ) {
       ...
       request = $.ajax({
           url: "https://script.google.com/macros/s/AKfycbxK6OlTh5D_HSAkgoQl9CgnmRmXsGbzpqzTqiC0isiFhJl0yeKN/exec",
           type: "post",
           data: serializedData
       });
       ...
       request.done(function (response, textStatus, jqXHR){
           ...
           $('#result').html('<a href="https://docs.google.com/spreadsheets/d/1KZ3jW3X7xtCzTP_iGhdsIUKjgHjzKqkvdXNn2z7izlA/edit?usp=sharing" target="_blank">Success - see Google Sheet</a>');
     console.log("Created.");
