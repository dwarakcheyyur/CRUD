jQuery( document ).ready(function( $ ) {
       ...
       request.done(function (response, textStatus, jqXHR){
           ...
           $('#result').html('<a href="https://docs.google.com/spreadsheets/d/10KF-G4xFJN-wd6K0XbAmRp-ZRRv2rZJSIsJlTN1Y9cs/edit#gid=0" target="_blank">Success - see Google Sheet</a>');
     console.log("Created.");
